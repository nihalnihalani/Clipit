...
class LocalAIService: ObservableObject {
    ...
    private func buildAnswerPrompt(question: String, clipboardContext: [(content: String, tags: [String])], appName: String?) -> String {
        ...
        let prompt = """
        You are a PastePup assistant. You only answer questions about the clipboard history. You don't answer questions about other topics. Answer the user's question based on the provided context from their clipboard history. /no_think
